...
const services: ServiceCard[] = [
    {
        ...
        highlightsKeys: ["services.1.h1", "services.1.h2", "services.1.h3"],
        icon: "square",
    },
    {
        id: 2,
        ...
        highlightsKeys: ["services.2.h1", "services.2.h2", "services.2.h3"],
        icon: "circle",
    },
    {
        id: 3,
        ...
        highlightsKeys: ["services.3.h1", "services.3.h2", "services.3.h3"],
        icon: "triangle",
    },
    {
        id: 4,
        ...
        highlightsKeys: ["services.4.h1", "services.4.h2", "services.4.h3"],
        icon: "hexagon",
    },
    {
        id: 5,
        ...
        highlightsKeys: ["services.5.h1", "services.5.h2", "services.5.h3"],
        icon: "square",
    },
    {
        id: 6,
        ...
        highlightsKeys: ["services.6.h1", "services.6.h2"],
        icon: "circle",
    },
];
